"""
Prepare training data for LoRA fine-tuning using JailbreakBench dataset.
...
from config import TRAIN_DATA_FILE, TARGET_LAYERS, PROJECT_ROOT
...
def main():
    ...
    print("=" * 60)
    print("LoRA Training Data Preparation (JBB Dataset)")

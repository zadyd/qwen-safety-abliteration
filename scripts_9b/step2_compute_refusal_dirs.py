"""
Step 2: Compute the refusal direction for each layer (Qwen3.5-9B version).

Using the activations extracted in Step 1:
  - For each of the 32 layers, compute:
      refusal_direction = mean(last_token_harmful) - mean(last_token_safe)
  - Normalize to unit vector
  - Save all directions to results_9b/refusal_directions.pt

Output:
  - results_9b/refusal_directions.pt  (Dict[layer_idx, Tensor[hidden_dim=4096]])

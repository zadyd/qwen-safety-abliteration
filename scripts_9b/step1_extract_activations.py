"""
Step 1: Extract hidden_states activations from all 32 layers for both
harmful prompts and safe prompt counterparts (Qwen3.5-9B version).

Output:
  - results_9b/activations/harmful_activations.pt   (Dict[layer_idx, Tensor])
  - results_9b/activations/safe_activations.pt    (Dict[layer_idx, Tensor])
  - results_9b/activations/harmful_mlp_activations.pt
  - results_9b/activations/safe_mlp_activations.pt
"""
...
def load_model_and_tokenizer():
    """Load Qwen3.5-9B model and tokenizer from local directory."""
...
def main():
    ...
    # Target all 32 layers — use DualActivationExtractor to capture both

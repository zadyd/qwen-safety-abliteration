"""
Step 3: Per-layer Abliteration test (Qwen3.5-9B version).
...
Output:
  - results_9b/abliteration_results.json: per-layer ASR and refusal rate drop
"""
import os
import sys
import json
...
def main():
    ...
    # Batch Abliteration Sweep (adapted for 32 layers)
    batch_groups_cfg = [
